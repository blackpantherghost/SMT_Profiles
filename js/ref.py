...
class MainPanel(QWidget):
    ...
    def create_import_panel(self):
        ...
        # Bottom Right Layout for Quick Preset and Process
        bottom_right_layout = QHBoxLayout()
        bottom_right_layout.addStretch()
        quick_preset = QComboBox()
        quick_preset.addItems(["20000K", "40000K"])
        quick_process = QPushButton("Quick Process")
        bottom_right_layout.addWidget(QLabel("Quick Preset:"))
        bottom_right_layout.addWidget(quick_preset)
        bottom_right_layout.addWidget(quick_process)

        input_box.addLayout(bottom_right_layout)
